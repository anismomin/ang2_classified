System.register(['angular2/core', 'angular2/router', './home/home.component', './signin/signin.component', './posts/posts.component', './viewPost/view.component', './createPost/createPost.component', '../services/SignInUpService'], function(exports_1) {
    ...
    var core_1, router_1, home_component_1, signin_component_1, posts_component_1, view_component_1, createPost_component_1, SignInUpService_1;
    var ClassifiedApp;
    return {
        setters:[
            function (core_1_1) {
            ...
            ClassifiedApp = (function () {
                ...
                ClassifiedApp = __decorate([
                    core_1.Component({
                        ...
                        directives: [home_component_1.HomeComponent, signin_component_1.SignInComponent, router_1.ROUTER_DIRECTIVES],
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/posts/create', name: 'CreatePost', component: createPost_component_1.CreatePostComponent, useAsDefault: true }
                    ]), 
                    __metadata('design:paramtypes', [SignInUpService_1.SignInUpService])
                ], ClassifiedApp);
